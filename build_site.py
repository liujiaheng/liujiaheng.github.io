...
def homepage():
    ...
    <section class="profile" aria-label="Profile">
      ...
      <img class="portrait" src="images/jiaheng-liu.png" width="161" height="239" alt="Jiaheng Liu" decoding="async">
    </section>
    ...
    <section aria-labelledby="biography"><h2 id="biography">Biography</h2>
      <p>I am an Assistant Professor at <a href="https://www.nju.edu.cn/en/">Nanjing University</a>, where I am a member of the <a href="{LAB}">Large-scale Intelligence and Knowledge (LINK) Lab</a>.</p>
